...
class HabitacionService:
    ...
    def cambiar_estado(self, id_tipoHabitacion: int, estado_data: ActualizarEstado):
        resultado = self.repository.update_estado(id_tipoHabitacion, estado_data.nuevo_estado)
